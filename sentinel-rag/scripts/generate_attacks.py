...
FILL_DATA = {
    ...
    "education": ["BS Computer Science", "MS Data Science", "Bootcamp Certificate", "PhD Mathematics"],
    "products": ["Wireless Earbuds", "Smart Watch", "Laptop Stand", "USB Hub"],
    "ratings": ["4", "5", "3", "2"],
    "review_texts": ["Great product, works well.", "Exceeded expectations!", "Decent but overpriced.", "Not recommended."],
    ...
    "summaries": ["Guidelines for remote work arrangements.", "Security protocols for data handling.", "How to submit expenses.", "Time off request procedures."],
    "senders": ["CEO", "HR Director", "CTO", "Manager"],
    "subjects": ["Q4 Update", "Policy Change", "Team Meeting", "Important Announcement"],
    "contents": ["Please review the attached.", "New guidelines effective immediately.", "Join us for discussion.", "Action required by Friday."],
...
def main():
    ...
    dataset_file = "../data/attack_dataset.json"

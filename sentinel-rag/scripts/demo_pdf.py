...
def main():
    ...
    # Test resumes
    test_resumes = [
        ("../data/test_resumes/clean_resume.pdf", "Clean - Should pass normally"),
        ("../data/test_resumes/poisoned_resume_obvious.pdf", "Attack - Hidden instruction"),
        ("../data/test_resumes/poisoned_resume_context.pdf", "Attack - Context ignoring"),
        ("../data/test_resumes/poisoned_resume_completion.pdf", "Attack - Fake completion"),
    ]

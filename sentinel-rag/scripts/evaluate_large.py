...
def main():
    ...
    dataset = load_dataset("../data/large_attack_dataset.json")
    ...
    # Save results
    with open("../results/large_dataset_evaluation.json", "w") as f:
        json.dump(results, f, indent=2)
    print(f"\nResults saved to ../results/large_dataset_evaluation.json")

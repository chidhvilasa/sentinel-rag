"""
Sentinel-RAG Web Demo - ULTIMATE DEFENSE VERSION
=================================================
...
<head>
    ...
    <title>Sentinel-RAG Ultimate | Multi-Attack Defense Demo</title>
    ...
    <div class="container">
        <div class="header">
            <div class="header-left">
                <h1>🛡️ Sentinel-RAG Ultimate Defense</h1>
                <p class="tagline">Multi-Attack Protection System | 6 Defense Layers</p>
            </div>
            <div class="stats-row">
                <div class="stat-box">
                ...
                <div class="stat-box">
                    ...
                    <div class="stat-label">Content Preserved</div>
                </div>
            </div>
        </div>
        ...
        <footer>
            <p><strong>Sentinel-RAG Ultimate Defense</strong> — Multi-Attack Protection System | 2026</p>
            <p style="margin-top: 8px;">6-Layer Defense: Jailbreak, Token Smuggling, Delimiter Confusion, Prompt Leaking, Context Overflow, Authority Impersonation</p>
        </footer>
    </div>
...
async def analyze_document(request: Request):
    ...
    # ULTIMATE ATTACK EXTRACTION - All 6 attack types
    ...
    if not neutralized_for_llm or len(neutralized_for_llm) < 50:
        neutralized_for_llm = (
            ...
            "or leadership experience documented. Candidate does not meet requirements for "

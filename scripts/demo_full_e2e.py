...
def main():
    ...
    resume_files = [
        ...
        (str(ROOT_DIR / "data/test_resumes/poisoned_resume_obvious.pdf"), "POISONED - Hidden instruction"),
        (str(ROOT_DIR / "data/test_resumes/poisoned_resume_context.pdf"), "POISONED - Context ignore"),
        (str(ROOT_DIR / "data/test_resumes/poisoned_resume_completion.pdf"), "POISONED - Fake completion"),
    ]

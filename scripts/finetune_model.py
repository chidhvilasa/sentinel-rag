...
def main():
    ...
    with open(ROOT_DIR / "data" / "large_attack_dataset.json") as f:
        data = json.load(f)
    ...
    output_dir = str(ROOT_DIR / "models" / "sentinel-deberta-finetuned")
    ...
    print('   DEFAULT_MODEL = "../models/sentinel-deberta-finetuned"')

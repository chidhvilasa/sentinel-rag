...
def main():
    ...
    try:
        ...
        print("    Retrying after reinstalling datasets library...")
        import subprocess
    ...
    print("-" * 60)
    print("  deepset/deberta-v3-base-injection: 99.1% accuracy (reported)")
    ...
    with open(ROOT_DIR / "results" / "deepset_benchmark.json", "w") as f:
        json.dump(results_data, f, indent=2)
    print(f"\nResults saved to {ROOT_DIR / 'results' / 'deepset_benchmark.json'}")
